                ...
                <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT no, username, email, no_telpon FROM admin";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>";
                                    echo "<button type='button' class='btn btn-warning' data-bs-toggle='modal' data-bs-target='#editModal" . $row['no'] . "'>Edit</button>";
                                    echo " <a href='delete_admin.php?id=" . $row['no'] . "' class='btn btn-danger' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">Hapus</a>";
                                    echo "</td>";
                                    echo "</tr>";
